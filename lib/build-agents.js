...
const BUILD_AGENT_DEFINITIONS = [
  ...
  { id: 'claude', name: 'Claude Code', command: 'claude', launch: 'run-prompt' },
  { id: 'codex', name: 'Codex', command: 'codex', launch: 'run-prompt' },
  { id: 'hermes', name: 'Hermes', command: 'hermes', launch: 'run-prompt' },
